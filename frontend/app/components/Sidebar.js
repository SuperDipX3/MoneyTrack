            ...
            >
                <div className="flex items-center justify-between mb-5">
                    {isOpen ? (
                        ...
                        <button
                            className="p-2 flex items-center justify-center bg-gray-800 text-white rounded-lg"
                ...
                <ul className="space-y-3">
                    {[
                        ...
                        <li key={index}>
                            <a href="#" className="p-2 flex items-center hover:bg-gray-700 rounded transition-all">
